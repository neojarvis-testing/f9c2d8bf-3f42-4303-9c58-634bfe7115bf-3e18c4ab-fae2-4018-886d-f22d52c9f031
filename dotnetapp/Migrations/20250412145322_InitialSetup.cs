        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientsProvided = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SkillLevel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SpecialRequirements = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CookingClassId = table.Column<int>(type: "int", nullable: false),
                    RequestDate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DietaryPreferences = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CookingGoals = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
